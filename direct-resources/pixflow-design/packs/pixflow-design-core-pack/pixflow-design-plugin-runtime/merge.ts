import type { PluginManifest } from '@pixflow-design/contracts';

// Merge a sidecar `pixflow-design.json` PluginManifest with one or more adapter
// outputs. `pixflow-design.json` always wins (spec §5.4); adapter values fill
