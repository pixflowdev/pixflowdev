...
import { projectKindToTracking } from '@pixflow-design/contracts/analytics';
...
export function registerChatRoutes(app: Express, ctx: RegisterChatRoutesDeps) {
  ...
  app.get('/api/runs', (req, res) => {
    ...
    /** @type {import('@pixflow-design/contracts').ChatRunListResponse} */
  ...
  app.post('/api/runs/:id/cancel', (req, res) => {
    ...
    /** @type {import('@pixflow-design/contracts').ChatRunCancelResponse} */
    const body = { ok: true };
    res.json(body);
  });
