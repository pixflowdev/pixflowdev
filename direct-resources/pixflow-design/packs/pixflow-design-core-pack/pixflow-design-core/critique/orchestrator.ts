...
import type { CritiqueConfig, PanelEvent } from '@pixflow-design/contracts/critique';
import { panelEventToSse } from '@pixflow-design/contracts/critique';
import type { CritiqueSseEvent } from '@pixflow-design/contracts/critique';
...
const tracer = trace.getTracer('@pixflow-design/daemon/critique');
