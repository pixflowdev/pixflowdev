import { defaultCritiqueConfig, FALLBACK_POLICIES } from '@pixflow-design/contracts/critique';
import type { CritiqueConfig } from '@pixflow-design/contracts/critique';
