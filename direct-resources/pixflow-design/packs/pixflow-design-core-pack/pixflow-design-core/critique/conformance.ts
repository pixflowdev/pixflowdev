...
import type { DegradedReason, PanelEvent, PanelistRole } from '@pixflow-design/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION } from '@pixflow-design/contracts/critique';
