...
// segment keeps the route collision-free and lets `pixflow-design/foo` (registry
...
export const PIXFLOW_DESIGN_SITE_ORIGIN = 'https://pixflow-design.ai';
...
// `pixflow-design/Hero Deck` -> `hero-deck`, `live-dashboard` -> `live-dashboard`.
...
// `pixflow-design/Hero Deck` -> `pixflow-design/hero-deck`. Used for the namespaced
...
// `/plugins/previews/pixflow-design/hero-deck/`.
...
export function pluginShareUrl(
  id: string,
  origin: string = PIXFLOW_DESIGN_SITE_ORIGIN,
): string {
