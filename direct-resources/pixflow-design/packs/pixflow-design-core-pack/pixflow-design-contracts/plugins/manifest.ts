...
// `pixflow-design.json` schema (v1). Mirrors docs/schemas/pixflow-design.plugin.v1.json
...
export const PIXFLOW_DESIGN_PLUGIN_SPEC_VERSION = '1.0.0';

export const PixflowDesignSpecVersionSchema = z.string().min(1);
...
export const PluginManifestSchema = z.object({
  ...
  specVersion: PixflowDesignSpecVersionSchema.optional(),
