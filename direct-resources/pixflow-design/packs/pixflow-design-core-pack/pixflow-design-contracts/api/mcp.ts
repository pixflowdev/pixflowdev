...
//
// Pixflow Design acts as an MCP CLIENT here: the user configures one or more
...
export interface McpServerConfig {
   ...
   * every run. */
  enabled: boolean;
  /** HTTP/SSE only: whether Pixflow Design should offer its managed OAuth flow.
 ...
 * its opener (and broadcasts on the `pixflow-design-mcp-oauth` channel). */
