...
export type AgentFixIntent =
  ...
  | { kind: 'rescan' }
  /**
   * Prompt the user to point Pixflow Design at an explicit binary by writing
...
export interface AgentInfo {
  ...
  /** Whether models came from the installed CLI or Pixflow Design's static fallback. */
