...
- Loads (muted, playsInline, crossOrigin="anonymous"): `https://plugin-assets.pixflow-design.ai/plugins/evergreen-finance/hf_20260517_070729_32a7eb4e-d6e2-4571-badc-91b4dab1ecbe-2db9b1.mp4`
...
Right column (FadeUp delay 0.15): a looping muted autoplay video `https://plugin-assets.pixflow-design.ai/plugins/evergreen-finance/hf_20260517_074029_c7a854bd-2d6e-4b62-96b3-ae8c16311e44-59f9be.mp4`, styled `w-full rounded-2xl object-cover aspect-square` inside `max-w-xs sm:max-w-sm`.
...
- **Card 1 — Smart Budgeting** (0.05): absolute object-cover bg image; gradient overlay `bg-gradient-to-t from-[#08150C]/80 via-[#08150C]/20 to-transparent`; top label Lucide `Sparkles` (16, white) + "Smart Budgeting"; bottom text "Let AI reshape how you plan your spending. Kova adapts to your…" (`text-white/80`).
  - Image: `https://plugin-assets.pixflow-design.ai/plugins/evergreen-finance/hf_20260517_061249_f20dfeda-1033-45ce-a3ee-070965599cbf-6c6b7e.webp&w=1280&q=85`
- **Card 2 — Bank-Grade Security** (0.15): same overlay; Lucide `ShieldCheck` (16, white) + "Bank-Grade Security"; bottom text "Keep your money safe with end-to-end encryption, live fraud alerts, and two-factor auth…".
  - Image: `https://plugin-assets.pixflow-design.ai/plugins/evergreen-finance/hf_20260517_061305_db631f5f-185f-4fda-a7a8-1dd7359ef2ea-4b7cdd.webp&w=1280&q=85`
...
- **Card 4 — Wealth Building** (0.35): same overlay; Lucide `TrendingUp` (16, white) + "Wealth Building"; bottom text "Grow your net worth with tools that help you set targets, monitor gains, and act…".
  - Image: `https://plugin-assets.pixflow-design.ai/plugins/evergreen-finance/hf_20260517_061316_50e651f8-02d0-4add-9ddb-7d81d15ac02e-24edde.webp&w=1280&q=85`
