...
## Pixflow Design orchestration mode

When this skill is invoked inside Pixflow Design, treat it as the design-flow
...
3. Search across every available Pixflow Design resource, not only this skill:
