...
- **Path:** `skills/editorial-collage/` → `skills/pixflow-design-landing/`.
- **Shared assets:** downstream paths such as `../editorial-collage/assets/`
  (for example from the slide-deck skill) should use
  [`../pixflow-design-landing/assets/`](./assets/) — see
  [`pixflow-design-landing-deck`](../pixflow-design-landing-deck/README.md).
...
- [`skills/pixflow-design-landing-deck/`](../pixflow-design-landing-deck/) — sibling skill that produces a slide deck in the same visual language.
