...
/**
 * pixflow-design-landing — SVG framework placeholder generator.
 *
...
<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 ${w} ${h}' width='${w}' height='${h}'>
  ...
  <text x='${w - inset - 14}' y='${h - inset - 14}' text-anchor='end' font-family='Inter Tight, system-ui, sans-serif' font-size='${dimsSize}' letter-spacing='2' fill='${INK_FAINT}'>PIXFLOW DESIGN · ATELIER ZERO</text>
</svg>`;
}
