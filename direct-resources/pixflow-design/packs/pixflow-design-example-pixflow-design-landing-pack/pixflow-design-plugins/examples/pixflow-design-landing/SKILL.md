...
description: >
  ...
  collage) — the same aesthetic Pixflow Design uses for its own marketing
...
sibling [`pixflow-design-landing-deck`](../pixflow-design-landing-deck/) skill)
...
This is the canonical Pixflow Design marketing-page recipe — the example
output is the very page you see at [pixflow-design](https://github.com/pixflowdev/pixflowdev).
...
worked example (Pixflow Design itself).
...
`pnpm --filter @pixflow-design/landing-page build` for a static `out/`
...
└── assets/
    ├── *.png                # 16 collage plates (Pixflow Design instance)
...
- [`skills/pixflow-design-landing-deck/`](../pixflow-design-landing-deck/) — sibling slides skill that reuses this design system.
