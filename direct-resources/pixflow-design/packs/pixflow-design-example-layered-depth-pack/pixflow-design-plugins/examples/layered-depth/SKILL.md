...
Videos:
- Hero background: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/bg-video_xsmysw-f9ba1c.mp4`
- Bird enter: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/bird-entrada_e72qt7-102269.webm`
- Bird idle 1: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/bird-idle_fzjami-a7d50b.webm`
- Bird idle 2: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/bird-idle2_rajmgo-a2bfbb.webm`
- Bird leave: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/bird-saida_ifroz1-4ad3cb.webm`
- Section 2 background: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/bg-2-video_sgbpqt-cdc7da.mp4`

Images:
- Q logo (declared, unused): `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/q-logo_isvugc-be3611.webp`
- Center sculpture / slab: `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/slab_v1_kb4vqk-eb36b8.webp`
- CTA card photo (Pexels): `https://plugin-assets.pixflow-design.ai/plugins/layered-depth/pexels-photo-3184465-a44809.webp`
